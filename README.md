...
- **Open access:** a shared-passphrase screen guarded the app during the private class-testing window; it was removed once testing opened up, so the live link now goes straight to the app.
